...
func DescribeSObject(co commons.Connection, name string) (*DescribeSObjectResult, error) {
	start := time.Now()
...
func DescribeSObjects(co commons.Connection, names []string) ([]*DescribeSObjectResult, error) {
	start := time.Now()
